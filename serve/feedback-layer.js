...
### Changelog
[numbered list matching feedback numbers, explaining what you changed]`}function tr(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var QG=`
  .hf-overlay {
    position: fixed;
    inset: 0;
    z-index: 10001;
...
`,kC=null,PC=null;function _C(e,r){PC=e,kC=r,XG()}function XG(){let e=document.createElement("style");e.textContent=QG,document.head.appendChild(e)}function RC(){let e=kC(),r=document.createElement("div");r.className="hf-overlay";let t=document.createElement("div");t.className="hf-modal";let n=document.createElement("div");n.className="hf-modal-header",n.innerHTML="<h2>Send Feedback to Claude</h2>";let i=document.createElement("button");i.className="hf-modal-close",i.textContent="\xD7",i.addEventListener("click",()=>r.remove()),n.appendChild(i);let o=document.createElement("div");o.className="hf-modal-body";let u=document.createElement("div");if(u.className="hf-modal-footer",t.append(n,o,u),r.appendChild(t),r.addEventListener("click",p=>{p.target===r&&r.remove()}),document.body.appendChild(r),e.length===0){o.innerHTML='<div class="hf-status hf-status-info">No comments yet. Ask reviewers to highlight text and add comments first.</div>';return}let l=document.querySelector(PC.contentSelector||"body").innerHTML,c=IC(l,e);o.innerHTML=`
  ...
  `;let s=document.createElement("button");s.className="hf-btn hf-btn-primary",s.textContent="Copy Prompt",s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(c),s.textContent="Copied!"}catch{s.textContent="Copy failed"}setTimeout(()=>s.textContent="Copy Prompt",2e3)}),u.appendChild(s);let f=document.createElement("button");f.className="hf-btn hf-btn-secondary",f.textContent="Close",f.addEventListener("click",()=>r.remove()),u.appendChild(f)}function AC(e){let r=[],t=new Map;for(let n of e)n.parent?(t.has(n.parent)||t.set(n.parent,[]),t.get(n.parent).push(n)):r.push(n);return{topLevel:r,repliesByParent:t}}function NC(e,r){return e.length>r?e.slice(0,r)+"...":e}function MC(e){let r=Date.now()-new Date(e).getTime(),t=Math.floor(r/6e4);if(t<1)return"just now";if(t<60)return`${t}m ago`;let n=Math.floor(t/60);return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`}var ln=null;function $C(e){ln=document.createElement("div"),ln.className="fb-toast-container",e.appendChild(ln)}function Cr(e,r="success"){if(!ln)return;let t=document.createElement("div");t.className=`fb-toast fb-toast-${r}`;let n=document.createElement("span");if(n.textContent=e,t.appendChild(n),r==="error"){let o=document.createElement("button");o.className="fb-toast-dismiss",o.innerHTML="&times;",o.addEventListener("click",()=>jC(t)),t.appendChild(o)}ln.appendChild(t),requestAnimationFrame(()=>{t.classList.add("fb-toast-visible")}),setTimeout(()=>jC(t),r==="error"?8e3:4e3)}function jC(e){e.classList.remove("fb-toast-visible"),e.addEventListener("transitionend",()=>e.remove(),{once:!0}),setTimeout(()=>{e.parentNode&&e.remove()},300)}var ZG=320,FC="feedback-layer-commenter",X=null,Be=null,De=null,js=null,DC=null,$s=null,Ls=null,Fs=null,Ds=null,Bs=!1,BC=[],GC=new Set;function at(){return localStorage.getItem(FC)||""}function UC({onSubmit:e,onDelete:r,onResolve:t,onReply:n,onEdit:i}){DC=e,$s=r,Ls=t,Fs=n,Ds=i,nU(),X=document.createElement("div"),X.className="fb-sidebar fb-sidebar-collapsed",X.innerHTML=`
  ...
  `;let o=document.createElement("button");o.className="fb-sidebar-tab",o.textContent="Feedback",o.addEventListener("click",()=>fn()),document.body.appendChild(o),document.body.appendChild(X),$C(X),Be=X.querySelector(".fb-comment-list"),De=X.querySelector(".fb-form-section");let u=X.querySelector(".fb-name-input");u.addEventListener("input",()=>{localStorage.setItem(FC,u.value.trim())}),X.querySelector(".fb-ai-btn").addEventListener("click",()=>RC()),X.querySelector(".fb-sidebar-toggle").addEventListener("click",()=>eU());let s=X.querySelector(".fb-show-resolved-cb");s.addEventListener("change",()=>{Bs=s.checked,nr(BC,GC)})}function fn(){X.classList.remove("fb-sidebar-collapsed"),document.querySelector(".fb-sidebar-tab").classList.add("fb-sidebar-tab-hidden")}function eU(){X.classList.add("fb-sidebar-collapsed"),document.querySelector(".fb-sidebar-tab").classList.remove("fb-sidebar-tab-hidden")}function WC(e){if(fn(),!at()){let n=X.querySelector(".fb-name-input");n.style.outline="2px solid #ef4444",setTimeout(()=>n.style.outline="",2e3)}js=e,De.style.display="",De.innerHTML=`
    <div class="fb-form-card">
      <div class="fb-form-quote">"${tr(NC(e,120))}"</div>
  ...
  `;let r=De.querySelector(".fb-form-textarea");r.focus();let t=()=>{if(!at()){let i=X.querySelector(".fb-name-input");i.focus(),i.style.outline="2px solid #ef4444",setTimeout(()=>i.style.outline="",2e3);return}let n=r.value.trim();n&&(DC({comment:n,commenter:at()}),De.style.display="none",js=null)};De.querySelector(".fb-submit-btn").addEventListener("click",t),r.addEventListener("keydown",n=>{n.key==="Enter"&&(n.metaKey||n.ctrlKey)&&(n.preventDefault(),t())}),De.querySelector(".fb-cancel-btn").addEventListener("click",()=>{De.style.display="none",js=null}),De.scrollIntoView({behavior:"smooth",block:"nearest"})}function nr(e,r=new Set,t=new Map){BC=e,GC=r,Be.innerHTML="";let{topLevel:n,repliesByParent:i}=AC(e),o=n.slice().sort((s,f)=>{let p=t.get(s.id),v=t.get(f.id);return!p||!v?0:p.compareBoundaryPoints(Range.START_TO_START,v)}),u=o.filter(s=>{let f=r.has(s.id),p=s.status==="closed";return f||p&&Bs}),l=Bs?u:u.filter(s=>s.status!=="closed");if(o.length===0){Be.innerHTML='<div class="fb-empty">No comments yet. Select text to add one.</div>';return}let c=o.filter(s=>!r.has(s.id)&&s.status!=="closed").length;if(l.length===0){c>0?Be.innerHTML=`<div class="fb-empty">
      ...
      </div>`:Be.innerHTML=`<div class="fb-empty">All ${o.length} comment(s) resolved. Check "Show closed" to see them.</div>`;return}for(let s of l){let f=document.createElement("div");f.className="fb-thread",f.appendChild(LC(s,!1));let p=i.get(s.id)||[];for(let d of p)f.appendChild(LC(d,!0));let v=document.createElement("button");v.className="fb-reply-btn",v.textContent="Reply",v.addEventListener("click",d=>{d.stopPropagation(),rU(s.id,f,v)}),f.appendChild(v),Be.appendChild(f)}}function LC(e,r){let t=e.status==="closed",n=document.createElement("div");return n.className="fb-cmt-card"+(t?" fb-cmt-closed":"")+(r?" fb-cmt-reply":""),n.dataset.id=e.id,n.innerHTML=`
  ...
  `,document.head.appendChild(e)}var ot=null,Hi=null,Ki=null,Y=[],Er=null,Ce=null,ye=new Set,Ge=new Map;function iU(){let e=document.currentScript||document.querySelector('script[src*="feedback-layer"]'),r={apiUrl:e?.dataset.apiUrl||"",contentSelector:e?.dataset.contentSelector||"body",documentUri:e?.dataset.documentUri||null,documentId:e?.dataset.documentId||null,proxyUrl:e?.dataset.proxyUrl||null,model:e?.dataset.model||null};Ws(r.apiUrl);async function t(){if(!(typeof window.mermaid>"u"||document.querySelectorAll(".mermaid").length===0)){console.log("[feedback-layer] Waiting for Mermaid to finish rendering...");try{await window.mermaid.run(),console.log("[feedback-layer] Mermaid rendering complete")}catch(o){console.warn("[feedback-layer] Error waiting for Mermaid:",o)}}}let n=async()=>{try{ot=document.querySelector(r.contentSelector)||document.body,Hi=r.documentUri||window.location.origin+window.location.pathname,Ki=r.documentId||null,UC({onSubmit:cU,onDelete:vU,onResolve:lU,onReply:fU,onEdit:pU}),TC(i=>{fn(),HC(i),Wi(i)}),uU(),await t(),aU(),_C(r,()=>Y)}catch(i){console.error("[feedback-layer] Boot failed:",i)}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n):n()}async function aU(){try{Y=await Hs(Hi,Ki),ye=await oU(Y),nr(Y,ye,Ge)}catch(e){console.error("[feedback-layer] Failed to load comments:",e),Cr(`Failed to load comments: ${e.message}`,"error")}}async function oU(e){OC();let r=new Set;Ge.clear();for(let t of e)if(!t.parent)try{let n=await Gi({exact:t.quote,prefix:t.prefix,suffix:t.suffix},ot);n&&t.status!=="closed"?(Ui(n,t.id),r.add(t.id),Ge.set(t.id,n)):n&&t.status==="closed"&&(r.add(t.id),Ge.set(t.id,n))}catch(n){console.warn(`[feedback-layer] Could not anchor comment ${t.id}:`,n)}return r}function uU(){document.addEventListener("mouseup",KC),document.addEventListener("keyup",KC)}function KC(){setTimeout(()=>{let e=window.getSelection();if(!e||e.isCollapsed||!e.rangeCount){pn();return}let r=e.getRangeAt(0),t=r.toString().trim();if(!t||t.length<3){pn();return}if(!ot.contains(r.commonAncestorContainer)){pn();return}sU(r)},10)}function sU(e){pn();let r=e.getBoundingClientRect();Ce=document.createElement("button"),Ce.className="fb-annotate-tooltip",Ce.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="12" y1="8" x2="12" y2="14"/><line x1="9" y1="11" x2="15" y2="11"/></svg>Comment',Ce.style.top=window.scrollY+r.top-36+"px",Ce.style.left=window.scrollX+r.left+r.width/2-40+"px",Ce.addEventListener("mousedown",async t=>{t.preventDefault(),t.stopPropagation();let n=window.getSelection();if(!n||n.isCollapsed)return;let i=n.getRangeAt(0);try{Er=await xC(i,ot),WC(Er.exact)}catch(o){console.error("[feedback-layer] Failed to create selector:",o)}pn()}),document.body.appendChild(Ce)}function pn(){Ce&&(Ce.remove(),Ce=null)}async function cU({comment:e,commenter:r}){if(Er){try{let t=await Vi({uri:Hi,document:Ki,quote:Er.exact,prefix:Er.prefix,suffix:Er.suffix,body:e,author:r});Y.push(t);let n=await Gi({exact:t.quote,prefix:t.prefix,suffix:t.suffix},ot);n&&(Ui(n,t.id),ye.add(t.id)),nr(Y,ye,Ge),window.getSelection().removeAllRanges()}catch(t){console.error("[feedback-layer] Failed to create comment:",t),Cr(`Failed to save comment: ${t.message}`,"error")}Er=null}}async function lU(e,r){try{let n=await Vs(e,r?"closed":"open"),i=Y.findIndex(o=>o.id===e);if(i!==-1&&(Y[i]=n),r)Ms(e);else{let o=n,u=await Gi({exact:o.quote,prefix:o.prefix,suffix:o.suffix},ot);u?(Ui(u,o.id),ye.add(o.id)):ye.delete(o.id)}nr(Y,ye,Ge)}catch(t){console.error("[feedback-layer] Failed to resolve comment:",t),Cr(`Failed to update comment: ${t.message}`,"error")}}async function fU({parent_id:e,comment:r,commenter:t}){try{let n=await Vi({uri:Hi,document:Ki,body:r,author:t,parent:e});Y.push(n),nr(Y,ye,Ge)}catch(n){console.error("[feedback-layer] Failed to create reply:",n),Cr(`Failed to save reply: ${n.message}`,"error")}}async function pU(e,r){try{let t=await Ks(e,{body:r}),n=Y.findIndex(i=>i.id===e);n!==-1&&(Y[n]=t),nr(Y,ye,Ge)}catch(t){console.error("[feedback-layer] Failed to edit comment:",t),Cr(`Failed to update comment: ${t.message}`,"error")}}async function vU(e){try{await zs(e),Ms(e),ye.delete(e),Y=Y.filter(r=>r.id!==e&&r.parent!==e),nr(Y,ye,Ge)}catch(r){console.error("[feedback-layer] Failed to delete comment:",r),Cr(`Failed to delete comment: ${r.message}`,"error")}}try{iU()}catch(e){console.error("[feedback-layer] Init failed:",e)}})();
