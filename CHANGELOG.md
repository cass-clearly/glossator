...
- `CLAUDE.md` simplified to pointers to `AGENTS.md` (workflow) and `PRINCIPLES.md` (engineering principles). Principles extracted to dedicated `PRINCIPLES.md`, eliminating duplication across agent files.
